      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarContent">
          <div className="navbar-nav ms-auto d-flex flex-column flex-lg-row">
            ...
            <Link className="nav-link text-dark px-3" to={"/events"}>
              Events
            </Link>
            <Link className="nav-link text-dark px-3" to={"/policies"}>
              Policies
            </Link>
            <Link className="nav-link text-dark px-3" to={"/volunteer"}>
              Volunteer
            </Link>
            <Link className="nav-link text-dark px-3" to={"/voting"}>
              Voting
            </Link>
          </div>
        </div>
